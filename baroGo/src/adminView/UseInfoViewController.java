 ...
 * @author 지중구
 *	메인창 회원메뉴 컨트롤러
 *	LoginController.java에서 primaryStage를 넘겨받아
 *	그 스테이지위에 팝업으로 회원정보창(Member.fxml)을 나타냄
 */
public class UseInfoViewController implements Initializable {
	...
	public void appendMsg(String msg)
	{
			...
			System.out.println("########### appendMsg 안에서 msg ###########");
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		// 통신을 위해 서버를 데몬스레드로 대기 시키고 요청이 올때만 활성화됌
